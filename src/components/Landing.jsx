  ...
  return (
    <div className="w-full relative ">
      ...
      <div className="bg-teal-600 p-2">
        <h1 className="uppercase text-3xl md:text-5xl text-center font-extrabold w-[300px] mx-auto bg-teal-600 text-white">
          EL GUERO
        </h1>
        <h2 className="uppercase text-3xl md:text-5xl text-center font-extrabold text-white">
          carnitas y barbacoa
        </h2>
      </div>
    </div>
